document.addEventListener('DOMContentLoaded', () => {
    ...
    const pageInitializers = {
        ...
        'page-get-involved': initializeGetInvolvedPage,
        'page-faqs': initializeFaqs,
        'page-my-profile': initializeMyProfilePage,
        'page-admin-panel': initializeAdminPanel,
    };
    ...
    function initializeScrollAnimations() { 
        ...
        if (animatedElements.length > 0) { 
            ...
            animatedElements.forEach((el, index) => {
                el.dataset.staggerIndex = index % 12; // Stagger up to 12 items in a grid
                observer.observe(el);
            }); 
        } 
    }
